...
// add_filter( 'genesis_search_text', 'rws_search_text' );
/**
 ...
 * @since 2.0.0
 */
function rws_search_text() {

	return esc_attr( __( 'Search Text Goes Here...', CHILD_THEME_TEXT_DOMAIN ) );

}

// add_filter( 'genesis_search_button_text', 'rws_search_button_text' );
/**
 ...
 * @since 2.0.0
 */
function rws_search_button_text( $text ) {

	return esc_attr( __( 'Click Here...', CHILD_THEME_TEXT_DOMAIN ) );

}

// add_action( 'template_redirect', 'rws_redirect_single_search_result' );
/**
 ...
 * @since 2.0.5
 */
function rws_redirect_single_search_result() {
...
// add_filter( 'pre_get_posts', 'rws_only_search_posts' );
/**
 ...
 * @since 2.0.18
 */
function rws_only_search_posts( $query ) {
